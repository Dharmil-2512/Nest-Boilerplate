...
export const errorMessages = {
  ...
  INVALID_SUBJECT:
    'Invalid subject type or subject not define, please add valid subject.',
  INCORRECT_PASSWORD: 'Invalid Email or Password.',
  USER_ALREADY_REGISTERED:
    'User already registered. Please log in or use a different email to create a new account',
  VERIFICATION_LINK_EXPIRED:
    'Email verification link is either invalid or expired',
  INCORRECT_DETAILS: 'Invalid email or password',
  USER_NOT_REGISTERED: `The email address is not associated with any account.Please check the email you entered or 
...
export const validationMessages = {
  ...
  DATE_OF_BIRTH_ISO_STRING:
    'The date of birth should be represented in the ISO 8601 standard format',
};
